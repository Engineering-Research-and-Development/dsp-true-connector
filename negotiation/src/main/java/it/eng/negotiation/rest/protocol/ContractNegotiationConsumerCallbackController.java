...
public class ContractNegotiationConsumerCallbackController {
	...
	// returns 201 with body ContractNegotiation
...
//		String finalCallback = callbackAddress + ContactNegotiationCallback.getNegotiationOfferConsumer(callbackAddress);
	...
	@PostMapping("/negotiations/{consumerPid}/agreement")
...
//		String finalCallback = callbackAddress + ContactNegotiationCallback.getProviderHandleAgreementCallback(callbackAddress);
	...
	// No callbackAddress
	@PostMapping("/negotiations/{consumerPid}/events")
	...
	// No callbackAddress
	@PostMapping("/negotiations/{consumerPid}/termination")
