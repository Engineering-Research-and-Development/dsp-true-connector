...
public class ContractNegotiationCallback {
    ...
    public static String getProviderEventVerificationCallback(String callback, String providerPid) {
        return PROVIDER_EVENTS.replace(":callback:", getValidCallback(callback)).replace(":providerPid:", providerPid);
    }
