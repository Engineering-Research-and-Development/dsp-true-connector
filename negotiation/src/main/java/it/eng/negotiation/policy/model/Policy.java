...
/**
 * Represents a policy that can be evaluated. Contains information about the
 * policy type, description, and attributes.
 */
@Getter
@EqualsAndHashCode
public class Policy {
	...
	private final LeftOperand type;
	...
	private Policy(String id, LeftOperand type, String description, boolean enabled, LocalDateTime validFrom,
			LocalDateTime validUntil, Map<String, Object> attributes, List<String> agreementIds) {
		this.id = id;
		this.type = type;
	 ...
	 * @return true if the policy is valid at the specified date and time, false
	 *         otherwise
	 */
	 ...
	 *
	 * @return true if the policy is valid at the current date and time, false
	 *         otherwise
	 */
	...
	public static class Builder {
		 ...
		 * @return this builder
		 */
		public Builder type(LeftOperand type) {
			this.type = type;
			return this;
		}
		 ...
		 */
		public Policy build() {
			return new Policy(id, type, description, enabled, validFrom, validUntil, new HashMap<>(attributes),
