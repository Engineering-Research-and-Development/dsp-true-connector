...
public class DownloadService {
    ...
    public DownloadService(S3AsyncClient s3AsyncClient, S3ClientService s3ClientService) {
    ...
    public CompletableFuture<String> uploadLargeStream(String presignedUrl,
                                                       String bucketName,
                                                       String key) {
