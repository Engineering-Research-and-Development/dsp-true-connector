...
public class ConsumerDataTransferCallbackControllerTest {
	...
	public void startDataTransfer() {
		...
		assertEquals(HttpStatus.OK, 
				controller.startDataTransfer(DataTransferMockObjectUtil.CONSUMER_PID,
						Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_START_MESSAGE)).getStatusCode());
	}
	...
	public void completeDataTransfer() {
		...
		ResponseEntity<JsonNode> response = controller.completeDataTransfer(DataTransferMockObjectUtil.CONSUMER_PID,
				Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_COMPLETION_MESSAGE));
	...
	public void terminateDataTransfer() {
		...
		ResponseEntity<JsonNode> response = controller.terminateDataTransfer(DataTransferMockObjectUtil.CONSUMER_PID,
	...
	public void suspenseDataTransfer() {
		...
		.thenReturn(DataTransferMockObjectUtil.TRANSFER_PROCESS_COMPLETED);
		ResponseEntity<JsonNode> response = controller.suspenseDataTransfer(DataTransferMockObjectUtil.CONSUMER_PID,
