...
public class ProviderDataTransferControllerTest {
	...
	public void initateDataTransfer() {
		when(dataTransferService.initiateDataTransfer(any(TransferRequestMessage.class)))
			.thenReturn(DataTransferMockObjectUtil.TRANSFER_PROCESS_REQUESTED_PROVIDER);
		ResponseEntity<JsonNode> response = controller.initiateDataTransfer(Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_REQUEST_MESSAGE));
	...
	public void initateDataTransfer_invalidBody() {
		assertThrows(ValidationException.class, () ->
			controller.initiateDataTransfer(Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_COMPLETION_MESSAGE))
		);
	}
	...
	public void initateDataTransfer_service_error() {
		...
		assertThrows(TransferProcessExistsException.class, () ->
			controller.initiateDataTransfer(Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_REQUEST_MESSAGE))
		);
	}
	// start
	@Test
	...
	ResponseEntity<JsonNode> response = controller.startDataTransfer(DataTransferMockObjectUtil.PROVIDER_PID,
			Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_START_MESSAGE));
	...
	public void startDataTransfer_invalidBody() {
		assertThrows(ValidationException.class, () ->
			controller.startDataTransfer(DataTransferMockObjectUtil.PROVIDER_PID, 
					Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_COMPLETION_MESSAGE)));
	}
	...
	public void completeDataTransfer() {
		...
		ResponseEntity<JsonNode> response =  controller.completeDataTransfer(DataTransferMockObjectUtil.PROVIDER_PID,
				Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_COMPLETION_MESSAGE));
		assertEquals(HttpStatus.OK, response.getStatusCode());
	}
	...
	public void completeDataTransfer_invalidBody() {
		assertThrows(ValidationException.class, () ->
			controller.completeDataTransfer(DataTransferMockObjectUtil.PROVIDER_PID, Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_START_MESSAGE))
		);
	}
	...
	public void terminateDataTransfer() {
		...
		ResponseEntity<JsonNode> response = controller.terminateDataTransfer(DataTransferMockObjectUtil.PROVIDER_PID,
				Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_TERMINATION_MESSAGE));
		assertEquals(HttpStatus.OK, response.getStatusCode());	
	}
	...
	public void terminateDataTransfer_invalidBody() {
		assertThrows(ValidationException.class, () ->
			controller.terminateDataTransfer(DataTransferMockObjectUtil.PROVIDER_PID, Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_START_MESSAGE))
		);
	}
	...
	public void suspenseDataTransfer() {
		...
		ResponseEntity<JsonNode> response =  controller.suspenseDataTransfer(DataTransferMockObjectUtil.PROVIDER_PID,
				Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_SUSPENSION_MESSAGE));
		assertEquals(HttpStatus.OK, response.getStatusCode());
	}
	...
	public void suspenseDataTransfer_invalidBody() {
		assertThrows(ValidationException.class, () ->
			controller.suspenseDataTransfer(DataTransferMockObjectUtil.PROVIDER_PID, Serializer.serializeProtocolJsonNode(DataTransferMockObjectUtil.TRANSFER_START_MESSAGE))
		);
	}
