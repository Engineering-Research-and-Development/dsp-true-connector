...
description: "Upgrade guidance for moving TRUE Connector code and build configuration from Java 17 to Java 21, covering modern language features, concurrency updates, and migration considerations."
---
...
Use this skill when a task upgrades Java language usage, build settings, or runtime behavior from Java 17 to Java 21.

The detailed guidance below was adapted from `.github/instructions/java-17-to-java-21-upgrade.instructions.md`.

# Use this skill when

- A task upgrades the project or a module from Java 17 to Java 21.
- You are evaluating Java 21 language or library features for code modernization.
- You need guidance on virtual threads, preview features, or post-upgrade build and test configuration.

# Instructions for Copilot

1. Prefer standard Java 21 features first and label preview features clearly as optional or gated.
2. Call out concurrency, GC, or preview-feature changes separately from routine syntax modernizations.
3. Update compiler, test, and runtime configuration together when enabling new platform capabilities.
