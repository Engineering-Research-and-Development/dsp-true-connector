...
description: "Java coding conventions for TRUE Connector, including code quality, Javadoc and Checkstyle expectations, and verification guidance."
---
...
Use this skill when working on Java source files in TRUE Connector and you need repository-specific guidance for code quality, naming, Javadoc, and build verification.

The detailed guidance below was adapted from `.github/instructions/java.instructions.md`.

# Use this skill when

- A task touches `**/*.java` files.
- You are creating or refactoring Java code and want the repository's preferred conventions.
- You need guidance on Javadoc, Checkstyle, code smells, or verification commands.

# Instructions for Copilot

1. Apply this skill together with `.github/copilot-instructions.md` for repository architecture and module conventions.
2. Prefer existing serializers, builders, and neighboring code patterns over generic examples when they differ.
3. Call out the relevant verification command when a change affects style gates, tests, or packaging.
