...
public class InternalAuthFlowIT extends BaseIntegrationTest {
    ...
    @Test
    @DisplayName("Full authentication lifecycle: login -> protected call -> refresh -> logout -> rejection of revoked token")
    void fullAuthLifecycleFlow() throws Exception {
        String email = "lifecycle@test.com";
        String password = "password123";
        createTestUser(email, password, true, false);
        ...
        // 5. Refresh-with-revoked-token rejection
    ...
    void loginFailurePaths() throws Exception {
        ...
        createTestUser(disabledEmail, password, false, false);
        ...
        createTestUser(lockedEmail, password, true, true);
    ...
    private void createTestUser(String email, String password, boolean enabled, boolean locked) {
