...
class DashboardMetricsServiceTest {
    ...
    void getSummary_aggregatesChildServiceResults() {
        ...
        NegotiationSnapshotMetrics negotiations = new NegotiationSnapshotMetrics(List.of(new KeyCount("CONFIRMED", 2)), List.of(), 2);
        TransferSnapshotMetrics transfers = new TransferSnapshotMetrics(List.of(new KeyCount("COMPLETED", 3)), List.of(), List.of(), List.of(), 3);
