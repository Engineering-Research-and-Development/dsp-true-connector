...
/** DSP DataFlowStartMessage — sent by Control Plane to Data Plane to initiate a transfer. */
@Getter
...
public class DataFlowStartMessage {
    ...
    public static class Builder {
        private final DataFlowStartMessage message = new DataFlowStartMessage();
        private Builder() {}
         ...
         *
         * @return validated DataFlowStartMessage
        ...
        public DataFlowStartMessage build() {
            ...
            throw new ValidationException("DataFlowStartMessage - " +
    ...
    public String getType() { return DataFlowStartMessage.class.getSimpleName(); }
}
