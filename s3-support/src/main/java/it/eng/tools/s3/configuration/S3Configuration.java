...
public class S3Configuration {
     ...
     */
    @Bean
    @ConditionalOnExpression("T(org.springframework.util.StringUtils).hasText('${s3.endpoint:}') "
            + "and !('${s3.endpoint:}'.toLowerCase().contains('amazonaws.com')) "
            + "and !('${s3.endpoint:}'.toLowerCase().contains('.aws.'))")
