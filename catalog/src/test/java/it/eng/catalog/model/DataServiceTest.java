...
public class DataServiceTest {
    ...
    @Test
    @DisplayName("Validate protocol - valid data service")
    ...
    @Test
    @DisplayName("Validate protocol - endpointURL null")
    public void validateProtocolEndpointURLNull() {
        DataService dataService = DataService.Builder.newInstance()
                ...
                .description(Set.of(CatalogMockObjectUtil.MULTILANGUAGE))
                .endpointDescription("Description for test")
                // No endpointURL set (will be null)
                .build();

        ValidationException exception = assertThrows(ValidationException.class,
                dataService::validateProtocol);
        assertEquals("DataService not valid according to protocol", exception.getMessage());
    }
}
