...
public class DataServiceAPIControllerTest {
    ...
    public void getDataServiceById_success() {
        ...
        assertTrue(Strings.CS.contains(response.getBody().toString(), CatalogMockObjectUtil.DATA_SERVICE.getType()));
    }
    ...
    public void saveDataService_success() {
        ...
        assertTrue(Strings.CS.contains(response.getBody().getData().get("type").toString(), CatalogMockObjectUtil.DATA_SERVICE.getType()));
    }
    ...
    public void deleteDataService_success() {
        ...
        assertNotNull(response);
        assertTrue(response.getStatusCode().is2xxSuccessful());
        assertTrue(Strings.CS.contains(response.getBody().getMessage(), "Data service deleted successfully"));
    }
