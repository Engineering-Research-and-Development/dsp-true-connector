...
@Configuration
@Slf4j
public class SimpleRestOkHttpClientConfiguration {
     ...
     */
    public SimpleRestOkHttpClientConfiguration(
    ...
    /**
     * Creates OkHttpClient bean with TLS support for DCP module.
     ...
     * <p>
     * Note: This bean has a specific name to avoid conflict with the OkHttpClient in tools module.
     * The tools module OkHttpClient will be used as the primary/default client.
     *
     * @return Configured OkHttpClient for DCP operations
     ...
     */
    @Bean(name = "dcpOkHttpClient")
    public OkHttpClient dcpOkHttpClient() throws KeyStoreException, NoSuchSslBundleException,
    ...
    /**
     * Creates SimpleOkHttpRestClient bean for DID resolution and HTTP operations.
     * This is a minimal wrapper around OkHttpClient without dependencies on tools module.
     * Uses the DCP-specific OkHttpClient instance.
     *
     * @param dcpOkHttpClient The DCP-specific OkHttpClient to wrap
     * @param objectMapper The ObjectMapper for JSON serialization/deserialization
     * @return SimpleOkHttpRestClient for DID resolution and HTTP operations
     */
    @Bean
    public SimpleOkHttpRestClient simpleOkHttpRestClient(OkHttpClient dcpOkHttpClient, ObjectMapper objectMapper) {
        log.info("Creating SimpleOkHttpRestClient with DCP OkHttpClient for DID resolution and HTTP operations");
        return new SimpleOkHttpRestClient(dcpOkHttpClient, objectMapper);
    }
