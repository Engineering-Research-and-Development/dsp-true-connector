...
/**
 * Minimal implementation of HTTP client functionality for DID resolution and generic HTTP operations.
 * This class provides HTTP request execution with optional JSON deserialization,
...
public class SimpleOkHttpRestClient {
    ...
    /**
     * Constructor with OkHttpClient only.
     * Uses a default ObjectMapper for JSON operations.
     *
